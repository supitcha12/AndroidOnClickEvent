...
public class Option3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_process_3:
                ...
                break;
            case R.id.btn_back3:
                Intent back =new Intent(Option3Activity.this,Option2Activity.class);
                startActivity(back);
                finish();
            case R.id.btn_next3:
                Intent next =new Intent(Option3Activity.this,Option4Activity.class);
                startActivity(next);
                finish();
        }
        hideKeyboardInput(v);
    ...
    private void initView(){
        ...
        findViewById(R.id.btn_next3).setOnClickListener(this); // Think about... Who is "this"?
    }
