...
public class Option4Activity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        findViewById(R.id.btn_back4).setOnClickListener(onClickListener);
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.btn_process_4:
                        ...
                        break;
                    case R.id.btn_back4:
                        Intent back =new Intent(Option4Activity.this,Option3Activity.class);
                        startActivity(back);
                        finish();
                    case R.id.btn_next4:
                        Intent next =new Intent(Option4Activity.this,Option5Activity.class);
                        startActivity(next);
                        finish();
                }
                hideKeyboardInput(v);
